...
namespace WindowsFormsApp1
{
    public partial class Visits : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            command.CommandText = "INSERT INTO visit (visit_reservation_id, visit_reasons, visits_diagnosis, visit_notes, visit_doctor_id, visit_date) VALUES (@id, @reasons, @diagnosis, @notes, @doctor_id, @date)";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            command = con.CreateCommand();
            command.CommandText = "UPDATE visit SET visit_reasons = @reasons, visits_diagnosis = @diagnosis, visit_notes = @notes WHERE visit_id = @id";
